...
const FormikLoginForm = withFormik({
	mapPropsToValues ({ email, password, firstName, lastName, address, phone, accountType }) {
		return {
			email     : email || '',
            password : password || '',
            firstName: firstName || '',
	...
	validationSchema : Yup.object().shape({
        ...
        firstName: Yup.string().required('You cannot pass!!!'),
        lastName: Yup.string().required('You cannot pass!!!'),
